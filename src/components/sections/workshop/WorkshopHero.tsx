      ...
      <div className="container mx-auto px-4 md:px-6 relative z-10">
        <div className="max-w-5xl mx-auto text-center">
          ...
          <FadeIn direction="up" delay={0.2}>
            <div className="text-lg md:text-xl text-white/80 font-medium leading-relaxed mb-12 max-w-3xl mx-auto border-l-4 border-blaze-orange pl-6 text-left space-y-3">
              <p>
